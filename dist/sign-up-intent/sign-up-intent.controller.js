...
let SignUpIntentController = class SignUpIntentController {
    constructor(signUpIntentService) {
        this.signUpIntentService = signUpIntentService;
    }
    create(createSignUpIntentDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_sign_up_intent_dto_1.CreateSignUpIntentDto]),
    __metadata("design:returntype", void 0)
], SignUpIntentController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], SignUpIntentController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], SignUpIntentController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_sign_up_intent_dto_1.UpdateSignUpIntentDto]),
    __metadata("design:returntype", void 0)
], SignUpIntentController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SignUpIntentController.prototype, "remove", null);
exports.SignUpIntentController = SignUpIntentController = __decorate([
    (0, common_1.Controller)('sign-up-intent'),
    __metadata("design:paramtypes", [sign_up_intent_service_1.SignUpIntentService])
